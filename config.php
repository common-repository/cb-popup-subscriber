...
function cb_pop_sub_enqueue() {
	...
	wp_localize_script( 'cb-popup-sub-cookie', 'cb_popup_dynamic_script', array(
		...
		'cb_cookie_expires'		=> $popup_cookie_expired,
	));
...
function cb_popup_sub_admin_menu() {
	// Add Sub menu
	add_submenu_page( 'options-general.php', __('CB MailChimp Popup Subscriber Page Title', 'cbpopup'), __('CB Popup Subscriber', 'cbpopup'), 'manage_options', 'cb_popup_sub.php', 'cb_popup_sub_admin_fun' );
